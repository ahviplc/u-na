...
public class StringUtils {
	...
	public static long getLong(String str, Long defaultData) {
		...
		try {
			...
			StaticLog.error("把String 转换为 long======== " + str);
		}
		return lnum;
	}
	...
	public static int getInt(String str, Integer defaultData) {
		...
		try {
			...
			StaticLog.error("把String转换成int数据========== " + str);
		}
		return inum;
	}
	...
	public static double getDouble(String str, Double defaultData) {
		...
		try {
			...
			StaticLog.error("把String转换成double数据: {}", str);
		}
		return dnum;
	}
	...
	public static float getFloat(String str, Float defaultData) {
		...
		try {
			...
			StaticLog.error("把String转换成float数据: {}", str);
		}
		return dnum;
	}
	...
	public static String getUUID() {
		...
		StaticLog.info("获取32位的UUID的调试日志-->>" + uuid);
		return uuid;
	}
